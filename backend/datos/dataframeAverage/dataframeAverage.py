...
df_nutrientes = pd.read_excel("biomasa_algas_promedio.xlsx", sheet_name="HojaNutrientes", engine="openpyxl");
...
df_temp = pd.read_excel("biomasa_algas_promedio.xlsx", sheet_name="HojaTemperaturas", engine="openpyxl")
...
# ============================================== BIOMASA ==============================================
df_biomasa = pd.read_excel("biomasa_algas_promedio.xlsx", sheet_name="HojaBiomasa", engine="openpyxl")
...
df_final.to_html("html/dataset_average_completo.html", index=False)
...
# Obtener colección
collection = get_collection("datasetAverage")  # Puedes usar otro nombre si lo prefieres
